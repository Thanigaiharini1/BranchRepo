...
public class StudentController {
	...
	@Operation(summary = "Update Student details with id",
			responses = {
					@ApiResponse(description = "Updated student details",content = @Content(mediaType = "application/json")),
					@ApiResponse(responseCode = "404", description = "Student not found with that id")})
	...
	@Operation(summary = "Delete Student details with id",
			responses = {
					@ApiResponse(description = "Deleted Successfully",content = @Content(mediaType = "application/json")),
					@ApiResponse(responseCode = "404", description = "Student not found with that id")})
